...
Sask_COVID <- read_csv("https://dashboard.saskatchewan.ca/export/cases/3598.csv")

Sk_pop <- read_csv("~/Data Science Work/COVID_DOC/SK_pop.csv")

#MB_Covid <- read_csv("C:/Users/andrew/Downloads/Manitoba_COVID-19_%E2%80%93_Daily_Cases_by_Status_and_RHA.csv")
```
...
ab_regions <- c("EDMONTON ZONE", "CENTRAL ZONE", "NORTH ZONE", "SOUTH ZONE")
